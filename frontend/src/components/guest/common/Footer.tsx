                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/binhnam.nguyen36" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-400 hover:text-primary-900 transition-colors">
                                <FacebookIcon size={16} />
                            </a>
                            <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-400 hover:text-primary-900 transition-colors"><InstagramIcon size={16} /></a>
                            <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-400 hover:text-primary-900 transition-colors"><YoutubeIcon size={16} /></a>
                            <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-400 hover:text-primary-900 transition-colors"><TikTokIcon size={16} /></a>
                        </div>
                    </div>
