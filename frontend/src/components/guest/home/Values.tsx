...
import traoQua from "@/assets/images/trao qua.jpg";
import hoanCanh from "@/assets/images/hoan-canh.jpg";
                ...
                <div className="grid lg:grid-cols-2 gap-16">
                    ...
                    <div className="relative">
                        <div className="grid grid-cols-2 gap-4">
                            <Image src={hoanCanh} className="rounded-2xl w-full h-full object-cover translate-y-8" alt="Volunteer" />
                            <Image src={traoQua} className="rounded-2xl w-full h-full object-cover" alt="Happy Kids" />
                        </div>
                    </div>
