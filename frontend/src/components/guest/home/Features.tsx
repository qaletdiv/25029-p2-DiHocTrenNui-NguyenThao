...
const features = [
    { title: "Caption 1", image: slide1 },
    { title: "Caption 2", image: slide2 },
    { title: "Caption 3", image: slide3 },
];
            ...
            <div className="grid md:grid-cols-3 gap-6">
                {features.map((feature, idx) => (
                    <div key={idx} className="group relative h-64 rounded-xl overflow-hidden cursor-pointer shadow-xl">
                        <Image src={feature.image} alt={feature.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
