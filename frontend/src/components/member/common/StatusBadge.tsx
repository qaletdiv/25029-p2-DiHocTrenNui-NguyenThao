...
import { STUDENT_STATUS, STUDENT_STATUS_TRANSLATIONS, DISBURSEMENT_STATUS, DISBURSEMENT_STATUS_TRANSLATIONS } from "@/hooks/constants";
...
const VARIANT_MAP: Record<string, string> = {
  ...
  [DISBURSEMENT_STATUS.HOLDING]: "bg-amber-100 text-amber-700",
  [DISBURSEMENT_STATUS.SENT_TO_TEACHER]: "bg-blue-100 text-blue-700",
  [DISBURSEMENT_STATUS.DELIVERED_TO_STUDENT]: "bg-emerald-100 text-emerald-700",
};
...
const LABEL_MAP: Record<string, string> = {
  ...
  // Disbursement lifecycle
  [DISBURSEMENT_STATUS.HOLDING]: DISBURSEMENT_STATUS_TRANSLATIONS[DISBURSEMENT_STATUS.HOLDING],
  [DISBURSEMENT_STATUS.SENT_TO_TEACHER]: DISBURSEMENT_STATUS_TRANSLATIONS[DISBURSEMENT_STATUS.SENT_TO_TEACHER],
  [DISBURSEMENT_STATUS.DELIVERED_TO_STUDENT]: DISBURSEMENT_STATUS_TRANSLATIONS[DISBURSEMENT_STATUS.DELIVERED_TO_STUDENT],
};
